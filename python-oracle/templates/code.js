...
btn1.onclick = function (evt) {  //для 1 кнопки
  ...
  pressed_button="";
  callContract();// сюда  добавим обработчик
...
], '0x0846850cca7dc939e7e6c1486fd87fe9d9fad285');  
            eth1155contract.methods.create_erc1155_token(1, 2).send(option,function(error,result){
                if (! error)
                    console.log(result);
                else
                    console.log(error);  
